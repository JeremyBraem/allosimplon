...
<body class="bg-[#FCFCFC]">
    ...
    <section>
        ...
        <form class=" lg:w-2/4 m-auto flex flex-col p-10" method="POST" action="traitement/traitementContact.php">
            ...
            <input class="border border-black p-1 bg-white rounded" type="text" name="email" required>
            <label class="mb-2 mt-7 text-xl">Nom :</label>
            <input class="border border-black p-1 bg-white rounded" type="text" name="name" required>
            <label class="mb-2 mt-7 text-xl">Prénom :</label>
            <input class="border border-black p-1 bg-white rounded" type="text" name="firstname" required>
